...
description = ['douceni 6_7 - maskovani rezu s GT maskou breast, namisto ctvrteho kanalu, k implants data pridane i dalsi non-implants data (all FNUSA data), bin segm'];
...
net = load('trainedUNet_6_7.mat','net').net;
